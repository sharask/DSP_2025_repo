...
/* USER CODE BEGIN PV */
static int16_t OutputBuffer[SAMPLES_QTY*2];		//Buffer to BSP_AUDIO_OUT, left+right channels
static int16_t Left_out_buffer[SAMPLES_QTY];
static int16_t Right_out_buffer[SAMPLES_QTY];
